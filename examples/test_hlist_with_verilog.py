...
if __name__ == "__main__":
    ...
    hlist = torchbit.core.Hlist.from_tensor(x)
    bin_file_path = dir_path / "dump.bin"
    hlist.to_binfile(bin_file_path)

    y = torchbit.core.Hlist.from_binfile(str(bin_file_path), 3, torch.bfloat16).to_tensor()
    ...
    y = torchbit.core.Hlist.from_binfile(str(output_bin_file_path), 3, torch.bfloat16).to_tensor()
